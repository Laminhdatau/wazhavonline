...
const Navbar: React.FC<{ toggleSidebar: () => void }> = ({ toggleSidebar }) => {
  ...
  return (
  <nav className="bg-gray-400 p-4 text-white flex justify-between">
    <button id="toggleSidebarButton" className="text-white hover:bg-gradient-outline-to-r hover:from-red-200 hover:to-orang-200" onClick={toggleSidebar}>
